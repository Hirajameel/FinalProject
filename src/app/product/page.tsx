...
function page() {
  return (
    <div className="">
      <Header />
      {/* bottom Header*/}
      <div className="flex  gap-5 bg-[#F9F1E7]  h-[100px]  justify-start">
        <p className="font-poppins flex items-center text-[#9F9F9F] ml-10">
          Home
          <IoChevronForwardSharp className="text-[#000000] ml-2" />
        </p>
        <p className="font-poppins flex items-center text-[#9F9F9F]">
          Shop
          <IoChevronForwardSharp className="text-[#000000] ml-2" />
        </p>
        ...
        <p className="font-poppins flex items-center text-[#000000]">
          Asgaard sofa
        </p>
      </div>
      {/* main page*/}
      ...
      <div>
        <div className="flex gap-10 justify-center">
          ...
          <div className="mt-5 font-poppins ml-10">
            ...
            <p className="text-[#9F9F9F] flex ml-10  justify-center items-center ">
              5 Customer Review
            </p>
            <p className="text-[#000000]  font-normal text-[13px] text-justify w-[424px] h-[80px] ">
            ...
            <div>
              <p className="text-[#9F9F9F] w-[38px] h-[21px] mt-4">Color</p>
              <br />
              <div className="flex">
            ...
            <div className="mt-3 flex gap-3 font-poppins p-2 ">
              ...
              <div>
                <button className="text-[#000000]  text-[20px] font-[400px] flex items-center gap-2 border border-[#000000]  rounded-[15px] w-[215px]  h-[64px] p-2 justify-center ">
                  Add To Cart
                </button>
              </div>

              <div className="text-[#000000] flex items-center gap-2 border border-[#000000] rounded-[15px] w-[123px] justify-center">
            ...
            <div className="grid grid-cols-[auto_minmax(0,_1fr)_auto] items-center text-[#9F9F9F]  font-bold ">
              <p className="text-left  mt-3">SKU</p>
              <span className="text-center">:</span>
              <p className="text-left">SS001</p>

              <p className="text-left mt-3">Category</p>
              <span className="text-center">:</span>
              <p className="text-left">Sofas</p>

              <p className="text-left mt-3">Tags</p>
              <span className="text-center">:</span>
              <p className="text-left">Sofa, Chair, Home, Shop</p>

              <p className="text-left mt-3">Share</p>
              <span className="text-center">:</span>
              <p className="text-left flex gap-4 ">
                Sofas{" "}
      ...
      <div className="font-poppins text-[24px] justify-center">
        ...
        <div className="flex items-center justify-center text-justify">
          <div className="text-center max-w-[800px] px-4">
            <p className="text-[#9F9F9F] text-[16px] font-normal text-sm mb-4">
              Embodying the raw, wayward spirit of rock ‘n’ roll, the Kilburn
              portable active stereo speaker takes the unmistakable look and
              sound of Marshall, unplugs the chords, and takes the show on the
              road.
            </p>
            <p className="text-[#9F9F9F] text-[16px] font-normal text-sm">
      ...
      <div className="w-[1230px] mx-auto my-0 product-main">
        ...
        <div className="grid grid-cols-4 gap-5 mb-4">
          ...
          <div className="text-center bg-[#F4F5F7] rounded-md">
            <Image
              ...
              className="w-full"
            />
            <h3 className="font-poppins text-[24px] mb-2">Syltherine</h3>
            <p className="font-poppins text-[16px] text-[#898989] mb-3">
              Stylish cafe chair
            </p>
            <div className="flex justify-center gap-2 items-center">
              <p className="font-poppins text-[20px]">Rp 2.500.000</p>
              <span className="line-through text-[#898989] text-[16px]">
                Rp 3.500.000
              </span>
            </div>
          </div>
          ...
          <div className="text-center bg-[#F4F5F7] rounded-md ">
            <Image
              ...
              className="w-full"
            />
            <h3 className="font-poppins text-[24px] mb-2">Leviosa</h3>
            <p className="font-poppins text-[16px] text-[#898989] mb-3">
              Stylish cafe chair
            </p>
            <div className="flex justify-center gap-2 items-center">
          ...
          <div className="text-center bg-[#F4F5F7] rounded-md">
            <Image
              ...
              className="w-full"
            />
            <h3 className="font-poppins text-[24px] mb-2">Lolito</h3>
            <p className="font-poppins text-[16px] text-[#898989] mb-3">
              Stylish cafe chair
            </p>
            <div className="flex justify-center gap-2 items-center">
          ...
          <div className="text-center bg-[#F4F5F7] rounded-md">
            <Image
              ...
              className="w-full"
            />
            <h3 className="font-poppins text-[24px] mb-2">Respira</h3>
            <p className="font-poppins text-[16px] text-[#898989] mb-3">
              Stylish cafe chair
            </p>
            <div className="flex justify-center gap-2 items-center">
        ...
        <div className="flex items-center justify-center mt-5 mb-5">
          <button className="border border-[#B88E2F] text-[#B88E2F] px-7 py-3">
            Show more
          </button>
        </div>
