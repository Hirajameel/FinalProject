...
function page() {
  ...
  <div className="flex flex-wrap gap-10 justify-center">
    ...
    {/* Main Image */}
    <div className="bg-[#F9F1E7] mt-5 rounded-[5px] w-full md:w-[423px] h-[500px] flex justify-center items-center">
      <Image
        src="/p-main.png"
        width={481}
        height={391}
    ...
    <div className="mt-5 font-poppins ml-10 w-full md:w-[424px]">
      ...
      <div className="mt-3 flex gap-3">
        ...
        <button className="text-[#000000] flex items-center gap-2 border border-[#000000] rounded-[15px] w-[123px] justify-center">
