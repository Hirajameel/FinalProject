...
function Section1() {
  return (
    <div className='w-[1183px] mb-5' style={{margin:"0 auto"}}>
        ...
        <div className='flex  justify-center space-x-3 mt-3  font-bold'>
            <div className='text-center'>
                <Image src="/sec(1).png" width={381} height={550} alt="" className='h-96'/>
                <h4 className='mt-2'>Dining</h4>
            </div>
            <div className='text-center'>
                <Image src="/sec(2).png" width={381} height={480}  alt="" className='h-96'/>
                <h4 className='mt-2'>Living</h4>
            </div>
            <div className='text-center'>
                <Image src="/sec(3).png"  width={381} height={480} alt="" className='h-96'/>
